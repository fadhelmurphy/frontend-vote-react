...
export default function AuthNav(props){
    return(
        ...
        <nav class="navbar navbar-dark bg-primary navbar-expand fixed-bottom d-md-none d-lg-none d-xl-none p-0 pb-2 m-3 rounded" style={{backgroundImage:'linear-gradient(to right, #00d2ff, #3a7bd5)'}}>
          <ul class="navbar-nav nav-justified w-100">
            <li class="nav-item">
            <Link to="/" class="nav-link pt-2 pb-0 px-0 text-white">
                <svg
                  width="1.5em"
                  height="1.5em"
                  viewBox="0 0 16 16"
            ...
            <li class="nav-item">
            <Link to="/register" class="nav-link pt-2 pb-0 px-0 text-white">
            <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" fill="currentColor" class="bi bi-person-plus" viewBox="0 0 16 16">
  <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H1s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C9.516 10.68 8.289 10 6 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/>
  <path fill-rule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5z"/>
</svg>
                <span class="mt-1 small d-block">Register</span>
                
                </Link>
            </li>
            <li class="nav-item">
            <Link to="/login" class="nav-link pt-2 pb-0 px-0 text-white">
  ...
  <path d="M9.5 6.5a1.5 1.5 0 0 1-1 1.415l.385 1.99a.5.5 0 0 1-.491.595h-.788a.5.5 0 0 1-.49-.595l.384-1.99a1.5 1.5 0 1 1 2-1.415z"/>
                ...
                <span class="mt-1 small d-block">Login</span>

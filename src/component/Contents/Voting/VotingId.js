...
<div className="row mb-3">
        ...
        <List isSelected={false} el={el} i={i} _getVote={value=>this._getVote(value)} handleChecked={value=>this.handleChecked(value)}/>
                                ...
                                <div class="card border-0 shadow rounded-lg mb-4">
                                  <img
                                    ...
                                    src={(
                                      ...
                                      process.env.REACT_APP_BACKEND+"storage/"+element.kandidatImage
